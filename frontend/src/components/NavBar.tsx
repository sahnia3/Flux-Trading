        ...
        <div className="mx-auto border-b border-white/5 bg-[#030712]/60 backdrop-blur-md">
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/holdings"
                className="hidden rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-slate-200 transition-all hover:bg-emerald-500/10 hover:border-emerald-500/30 hover:text-emerald-400 sm:inline-flex items-center gap-2"
              >
                Holdings
              </Link>
              ...
              <div className="relative">
                ...
                >
                  U
                  {/* Status Dot */}
                  <span className="absolute bottom-0 right-0 h-2.5 w-2.5 rounded-full bg-emerald-500 ring-2 ring-[#030712]" />
                </button>
                ...
                {menuOpen && (
                  <div className="absolute right-0 mt-4 w-56 origin-top-right rounded-2xl border border-white/10 bg-[#0f172a]/90 p-2 shadow-2xl backdrop-blur-xl animate-in fade-in zoom-in-95 duration-200">
                    <div className="mb-2 px-3 py-2 bg-white/5 rounded-xl border border-white/5">
                      ...
                      <p className="truncate text-sm font-bold text-white">Demo User</p>
                    </div>
                    <Link
                      href="/account"
